...
![이미지](./img/streamlit-page1.png)<br/><br/>
![이미지](./img/streamlit-page2.png)

## 📌 주요 기능
### 1⃣ 고객 이탈 예측 🔍
- 사용자가 **고객 정보를 입력**하면 머신러닝 모델이 **이탈 가능성을 확률(%)로 예측**합니다.
- 모델은 **과거 고객 데이터**를 학습하여, 특정 고객이 이탈할지 여부를 판단합니다.

### 2⃣ 이탈 고객 TOP 50 분석 📊
- 가장 이탈 가능성이 높은 **고객 50명의 데이터**를 보여줍니다.
- 어떤 특징을 가진 고객이 이탈하는지 분석하여 **인사이트를 제공합니다.** 
</br>
