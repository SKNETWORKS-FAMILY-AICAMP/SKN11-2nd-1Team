...
### 주요 타겟 선정
- **고요금제 구독자**: 요금 인하 캠페인으로 이탈률 감소.  
- **장기 거주자 및 고소득 고객**: 프리미엄 서비스 강화와 장기 구독 할인으로 충성도 향상.

---

### 위험 고객 예측
- **특징**: 주간 요금이 높고 거주 기간이 짧은 고객.  
- **전략**: 특별 혜택 제공 및 만족도 조사로 불만 요소 파악.
...
- **고객 유형별 구독 플랜**:  
  - 고소득층: 고급 콘텐츠 및 부가 서비스 제공.  
  - 저소득층: 요금 부담 완화 정책 적용.

---

### 서비스 개선 방향
- **고객 세분화**: 상관관계 높은 변수를 기반으로 마케팅 전략 구체화.  
- **패키지 상품 개발**: 배달 빈도와 주간 요금제를 결합한 패키지로 가격 민감도 완화.
